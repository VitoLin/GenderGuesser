...
if __name__ == '__main__':
    ...
    if args.model == 'vggface2':
        trained_model = InceptionResnetV1(pretrained = 'vggface2', device = device, classify=False)
        trained_model = trained_model.eval()
    elif args.model == 'casia':
        trained_model = InceptionResnetV1(pretrained = 'casia-webface', device = device, classify=False)
        trained_model = trained_model.eval()
    else:
    ...
    # save testing data
    torch.save(test_data, celeb_dir / 'test_data.pt')